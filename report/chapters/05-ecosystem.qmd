...
| Honeydew | import のみ | 有償・要問い合わせ[^honeydew] |
...
いずれもアクセス日 2026-07-19。各社ごとの確認手段と参照文献は @sec-method に整理してある。

[^honeydew]: Honeydew は有償製品で、対応の詳細は要問い合わせ。公開ドキュメント上では import 方向の対応が確認できた。アクセス日 2026-07-19
